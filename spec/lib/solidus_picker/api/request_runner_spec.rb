RSpec.describe SolidusPicker::Api::RequestRunner do
  ...
  describe '#call' do
    context 'when the response code is 2xx' do
      it 'returns the parsed response' do
        stub_request(:post, %r{ssapi.picker.com/test}).with(
    ...
    context 'when the response code is 429' do
      it 'raises a RateLimitedError' do
        stub_request(:post, %r{ssapi.picker.com/test}).to_return(
          status: 429,
        ...
        }.to raise_error(SolidusPicker::Api::RateLimitedError)
      end
    end
    ...
    context 'when the response code is not 200 or 429' do
      it 'raises a RequestError' do
        ...
        expect {
          request_runner.call(:post, '/test')
        }.to raise_error(SolidusPicker::Api::RequestError)
      end
    end
  end
end
