...
RSpec.describe Spree::PickerController do
  render_views
  ...
  describe '#export' do
    ...
    context 'when the authentication is valid' do
      ...
      it 'generates picker-compliant XML' do
        stub_picker_auth
        create(:order_ready_to_ship)
        ...
        expect(response.body).to pass_validation('spec/fixtures/picker_xml_schema.xsd')
      end
    end
  end
  ...
  def stub_picker_auth(username = 'mario', password = 'lemieux')
